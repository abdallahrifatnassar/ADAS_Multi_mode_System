...
int main ()
{
	...
	MGPIO_voidSetPinPullType(MGPIO_PORTA,MGPIO_PIN5,MGPIO_PULL_DOWN);
	...
	while (1)
	{
		...
		volatile int Difference = Local_u32FinalValue-Local_u32initalValue;
		Distance=(0.136f * (Difference));
		itoa(Distance, distanceArr, 10);
